/*
========================================================================================
VS2022 UNIVERSAL PE PACKER - FULLY WORKING VERSION
========================================================================================
...
int main(int argc, char* argv[]) {
    ...
    if (argc > 1) {
        ...
        for (int i = 1; i < argc; i++) {
            ...
            if (stringEndsWith(filepath, ".exe")) {
