...
public:
    ...
    void basicFileEncryption() {
        ...
        std::cout << "XOR Key (Hex): " << bytesToBigDecimal(keys.xor_key) << std::endl;
    }
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "  MinGW: g++ -std=c++17 -O2 -static -DWIN32_LEAN_AND_MEAN VS2022_MenuEncryptor_Clean.cpp -o VS2022_Packer.exe -lwininet -ladvapi32" << std::endl;
    std::cout << "  MSVC:  cl /std:c++17 /O2 /DWIN32_LEAN_AND_MEAN VS2022_MenuEncryptor_Clean.cpp /Fe:VS2022_Packer.exe wininet.lib advapi32.lib" << std::endl;
    
    std::cout << "\n========================================================" << std::endl;
    std::cout << "VS2022 Universal PE Packer v2.0 - Windows Enhanced!" << std::endl;
    std::cout << "Developed for advanced software protection" << std::endl;
    std::cout << "========================================================" << std::endl;
