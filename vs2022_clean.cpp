...
private:
    ...
    std::vector<std::string> generateMenuOptions() {
        std::vector<std::string> options = {
            ...
            "[DECRYPT] Decrypt Protected Data",
            "[KEYGEN] Generate Security Keys",
            "[FILE] Process File Batch",
...
public:
    ...
    void displayMenu() {
        ...
        for (size_t i = 0; i < options.size(); ++i) {
            ...
            std::cout << std::left << std::setw(50) << options[i] << "\n";
        }
    ...
    void encryptFile(const std::string& filePath) {
        ...
        std::cout << "[SUCCESS] File encrypted: " << outPath << std::endl;
    }
    ...
    void decryptFile(const std::string& filePath) {
        ...
        std::cout << "[SUCCESS] File decrypted: " << outPath << std::endl;
    }
            ...
            switch (choice) {
                case 1: {
                    ...
                    try {
                        ...
                        std::cout << "\n[SUCCESS] Encrypted: " << encrypted.substr(0, 64) << "...\n";
                        std::cout << "[INFO] Full result saved to clipboard simulation.\n";
                ...
                case 2: {
                    ...
                    try {
                        ...
                        std::cout << "\n[SUCCESS] Decrypted: " << decrypted << std::endl;
                    } catch (const std::exception& e) {
                        std::cout << "[ERROR] " << e.what() << std::endl;
                    }
                    break;
                ...
                case 3: {
                    std::cout << "\n[KEYGEN] Generating security keys...\n";
                    TripleKey keys;
                    generateSecureBytes(keys.chacha_key);
                    generateSecureBytes(keys.aes_key);
                    generateSecureBytes(keys.xor_key);
                ...
                case 15: {
                    std::cout << "\n[EXIT] Exiting VS2022 Menu Encryptor...\n";
                    std::cout << "[INFO] All operations completed securely.\n";
                    return;
                }
                default: {
                    std::cout << "\n[INFO] Feature [" << choice << "] is under development.\n";
                    std::cout << "[INFO] Advanced security modules loading...\n";
                    ...
                    std::cout << "[SUCCESS] Module initialized successfully!     \n";
                    break;
                }
            }
    ...
    void compileSelf(const std::string& sourceFile = __FILE__) {
        std::cout << "\n[COMPILE] Initiating self-compilation process...\n";
