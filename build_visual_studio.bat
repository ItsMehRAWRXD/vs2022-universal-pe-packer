@echo off
echo Building BenignPacker with Visual Studio 2022...
echo ================================================
...
if errorlevel 1 (
    ...
    echo 2. Check that all source files exist in the correct locations
    echo 3. Verify that PluginFramework/IPlugin.h exists
    echo 4. Make sure all project files are properly configured
    echo ================================================
    pause
    exit /b 1
)
...
echo Output: BenignPacker\Release\x64\BenignPacker.exe
echo ================================================

REM Test the executable
if exist "BenignPacker\Release\x64\BenignPacker.exe" (
    echo Testing BenignPacker...
    echo Creating test payload...
    echo Test payload data > test_payload.bin
    
    echo Running BenignPacker...
    BenignPacker\Release\x64\BenignPacker.exe test_payload.bin test_output.exe advanced
...
echo You can now use: BenignPacker\Release\x64\BenignPacker.exe <input_file> [output_file] [method]
echo ================================================
pause